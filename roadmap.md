...
- [x] Clarify next step for remixed project
- [x] Replace 6 preview slides with new uploaded map images (image.png, image-2.png, image-3.png, image-4.png, image-5.png, image.webp)
